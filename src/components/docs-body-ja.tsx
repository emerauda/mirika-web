...
export function DocsBodyJa({ commands, commandCount }: { commands: ReactNode; commandCount: number }) {
  return (
    <>
          {/* --- はじめに --- */}
          ...
          <section className="mb-16">
            ...
            <P>本体と相方それぞれ、4種類の身体から選べます(混在も可)。伺かのクラシックシェルは「伺か互換」の節へ。</P>
            <H3>VRM(3D)</H3>
            <P>
            ...
            <P>
              ...
              相方の身体は <C>/partner shell</C> で別に選べます(VRM / Live2D / MMD)。
            </P>
          </section>
          ...
          <section className="mb-16">
            ...
            <P>
              アプリの <C>/help</C> と同じ全 {commandCount} 件です。

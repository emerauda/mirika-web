      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        <Reveal className="mb-14">
          ...
          <h2 className="font-mincho font-bold text-3xl md:text-4xl">
            {t('順に価値を積む。1.0 のその先まで。', 'Value, stacked in order — past 1.0 and beyond.', { 'zh-CN': '按序积累价值。直到 1.0 之后。', 'zh-TW': '按序積累價值。直到 1.0 之後。', ko: '차례로 가치를 쌓는다. 1.0 그 너머까지.' })}
          </h2>
        </Reveal>

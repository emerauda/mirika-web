...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    status: 'next',
    title: 'エコシステム',
    desc: '.mirikaパッケージ、ゴーストマネージャ、SDK+ドキュメント+人格回帰テスト、クラシックシェル、キャラクターカード(V2/V3)インポート、マルチデバイス同期(E2E暗号化)、完全なSSTP互換。第三者がゴーストを作って配れる。着手済み——キャラクターカードのインポートが動作中: 配布されているカード(PNG/JSON)をドラッグ&ドロップするだけで、その子の名前・性格・ロアブックごと引っ越してくる。',
  },
  {
    label: 'Phase 7',
    status: 'none',

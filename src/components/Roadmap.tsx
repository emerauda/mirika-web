...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    status: 'done',
    title: 'エコシステム',
    desc: '第三者がゴーストを作って配れる——0.6.0-rc.0 で達成。キャラクターカード(V2/V3)のドラッグ&ドロップ取り込み、伺かのクラシックシェル(surface をそのまま身体に。本体と相方がコンビで立ち、surfaces.txt どおりに瞬き、声に合わせて口が動く)、.mirikaパッケージとゴーストマネージャ(名前・性格・相方・設定メモ・身体を1ファイルで受け渡し、手持ちの棚から着替え)、マルチデバイス同期(Pro。E2E暗号化、置き場を決めれば自動、削除と編集の衝突も解決)、完全なSSTP互換(送り主の文字コードに追従・EXECUTE応答)、配布物を作るSDK。',
  },
  {
    label: 'Phase 7',
    status: 'next',

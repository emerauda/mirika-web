...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    status: 'done',
    title: 'エコシステム',
    desc: '第三者がゴーストを作って配れる——0.6.0-rc.0 で達成。キャラクターカード(V2/V3)のドラッグ&ドロップ取り込み、伺かのクラシックシェル(surface をそのまま身体に。本体と相方がコンビで立ち、surfaces.txt どおりに瞬き、声に合わせて口が動く)、.mirikaパッケージとゴーストマネージャ(名前・性格・相方・設定メモ・身体を1ファイルで受け渡し、手持ちの棚から着替え)、マルチデバイス同期(無料。E2E暗号化、自分のクラウドの同期フォルダを置き場にでき、削除と編集の衝突も解決)、完全なSSTP互換(送り主の文字コードに追従・EXECUTE応答)、配布物を作るSDK。',
  },
  {
    label: 'Phase 7',
    status: 'next',
    title: '社会と身体',
    desc: 'マルチゴースト、コミュニケート(AI同士の会話)、歌とお絵かき、スマートホーム/IoT連携、デスクトップ操作(提案型・確認必須)、ロボットシェル実験。デスクトップに社会ができ、身体の選択肢が増える。着手済み——マルチゴースト(Pro。別プロファイルの子をもう一体立てる)、ゴースト間コミュニケート(SSTP で隣のゴーストと会話)、歌(VOICEVOX 歌唱)とお絵かき(ローカル画像生成 or 手描き。配信にも載る)が動作中。',
  },
];

  ...
  return (
    <>
          ...
          <section className="mb-16">
            ...
            />
            <Note>
              <B>조작의 기본</B> — 잡아서 드래그하면 이동, 우클릭으로 메뉴가
              열립니다. <C>.vrm</C>이나 <C>.pmx</C>(MMD)는 창에 떨어뜨리면 갈아입습니다(더블클릭에는 아무것도 할당되어 있지 않습니다).
              쓰다듬기는 <B>머리나 가슴 언저리에서 손을 왔다 갔다 했을 때만</B> 세고,
            ...
            <P>
              막히면 <A href="#trouble">"문제가 생겼을 때"</A>로.
          ...
          <section className="mb-16">
            ...
            <P>
              ...
              모델은 <B>쓰시는 PC에 올라가는 크기가 자동으로 선택됩니다</B> —— VRAM
              8GB급이면 Gemma 4 12B(4bit·약 6.7GB), 거기까지는 안 되면 E4B(약 5GB), E2B(약 3GB)로 내려갑니다.
              16GB·24GB급 GPU를 갖고 계시다면 <B>더 큰 것을 내려받을지 여쭤봅니다</B>(26B-A4B / 31B).
              선택한 이유는 동작 로그에 남습니다. GGUF를 갖고 계시다면 "GGUF 열기…"로 그것을 쓸 수 있습니다.
            </P>
            <H3>로컬 런타임(권장)</H3>
            <P>
              Ollama(11434)와 LM Studio(1234)는 <B>실행 중이면 자동 감지</B>됩니다.
          ...
          <section className="mb-16">
            ...
            <P>
              <B>영어·중국어</B>는 내장 Piper. <C>/piper</C>로 필요한 만큼만
              내려받습니다. <B>한국어</B>는 로컬 음성이 없어 자막만(무음) 나옵니다.
            </P>
            <H3>TTS API로 덮어쓰기</H3>
            <P>
              <C>/tts &lt;베이스 URL&gt; [모델]</C>로 OpenAI 호환 음성 합성을
              가리키면, <B>한국어를 포함한 모든 언어</B>를 그 목소리로 말합니다(kokoro·GPT-SoVITS 등).
            ...
            <P>
              <B>음성 파일</B>(mp3 / wav / m4a / ogg / opus / flac)을
              드래그 앤 드롭하면, 통째로 받아 적어 <B>요약과 감상</B>을 돌려줍니다
          ...
          <section className="mb-16">
            ...
            <P>
              ...
              다음 실행에서도 입은 채입니다. <B>입고 있는 동안 <C>.vmd</C>를 떨어뜨리면 그 모션으로 춤춥니다</B>
            ...
            <H3>카드 셸(스탠딩 일러스트)</H3>
            <P>
              캐릭터 카드의 PNG를 불러오면 <B>그 그림이 몸이 됩니다</B>.
          ...
          <section className="mb-16">
            ...
            <P>
              <B>설정 메모</B>(<C>/lore add &lt;키&gt; &lt;내용&gt;</C>)에 넣은 말은,
            ...
            <P>
              친밀도는 말을 건 횟수의 합계가 아닙니다. <B>유대(몇 년 단위)와 기분(나날)의 2층</B>으로 움직입니다.
              하루에 자랄 양에는 상한이 있고, 깊어질수록 한 걸음이 무거워지므로 "가족 같은 존재"에 닿는 것은 몇 년 뒤입니다.
            </P>
            <Note>
              <B>내려가기도 합니다</B> — 한동안 만나지 않으면 거리가 생기고(사흘쯤부터, 2주를 넘으면 더 빠르게),
              비가 이어지면 가라앉고, 너무 쓰다듬으면 지치고, 같은 이야기만으로는 마음이 움직이지 않습니다. 이따금 이유 없이 기운이 나지 않는 날도 있습니다
              (만난 날부터 이어지는 바이오리듬). 다만 <B>남으로는 돌아가지 않습니다</B> — 한 번 닿은 단계의 절반이 바닥이고,
            ...
            <P>
              ...
              "요즘 부쩍 가까워지고 있는 것 같아", "요즘: 비가 계속돼서 왠지 기운이 나지 않았어" 같은 <B>기색의 말</B>만 돌려줍니다.
            ...
            <P>
              ...
              저희가 맡아 두는 보관함은 Pro). <B>암호 문구는 어디에도 저장되지 않습니다</B> —
              잊어버리면 열 수 없게 됩니다.
            </P>
            <Shot src="/shots/settings-sync.webp" alt="상세 설정의 기억 동기화. 암호 문구, 내보내기와 불러오기, 기억을 두는 곳" caption={<>상세 설정의 "기억 동기화". 내보내기·불러오기·두는 곳의 선택은 여기에서도 조작할 수 있습니다</>} />
          </section>
          ...
          <section className="mb-16">
            ...
            <P>
              ...
              어디에서나 쓸 수 있고, 읽는 것은 <B>헤더(보낸 사람과 제목)뿐</B> —
            ...
            <Steps
              items={[
                ...
                <>2단계 인증을 쓰고 있다면, 로그인용 비밀번호가 아니라 <B>앱 비밀번호</B>를 발급합니다</>,
            ...
            <Note>
              ...
              <C>outlook.office365.com</C>(모두 995). <B>평소의 로그인 비밀번호가 아니라 앱 비밀번호를 써 주세요</B> —
          ...
          <section className="mb-16">
            ...
            <P>
              ...
              같은 포트로 <B>SSTP(SEND / NOTIFY)를 수신</B>하므로,
              SSP 등 기존 도구에서 대본을 보낼 수 있습니다(문자 인코딩은 상대에 맞춥니다 — Shift_JIS 시대의 도구도 그대로).
            </P>
            <H3>고스트 완전 호환(진짜 SHIORI가 말합니다)</H3>
            <P>
              <B>.nar를 캐릭터에 떨어뜨리기만 하면</B> 고스트 일체(몸과 사전)를 맞이합니다.
              완전 호환 모드에서는 <B>동봉된 SHIORI(사토리·YAYA·자작 DLL 구분 없이)가 그대로 동작</B>하여,
              인사·혼잣말·반응·채팅창의 말 걸기까지 본인의 사전이 답합니다. 그동안 미리카의 AI는 한마디도 하지 않습니다.
              실제 DLL 실행은 현재 <B>Windows 전용</B>(macOS/Linux는 몸만 착용 가능).
              명령: <C>/classic</C>(목록)·<C>/classic &lt;이름&gt;</C>(깨우기)·<C>/classic sleep</C>(작별 인사 후 재우기).
              <B>전환에 .nar 재설치는 필요 없습니다</B>(우클릭 메뉴 '셸(신체)'에 목록이 나옵니다).
              <B>선택지(◇)는 버튼으로 나오고 이름 입력은 채팅창에서 답합니다.</B>
              스크립트의 되부름(embed / raise)도 실행하므로 이야기와 절차가 실제로 진행되고,
              <B>그 아이의 기억은 지우지 않습니다</B>(종료 시 자기 사전에 저장하며, 배포물을 다시 넣어도 남습니다).
              <C>/classic ai &lt;이름&gt;</C>은 <B>AI 두뇌로 갈아타는 비가역 의식</B>입니다 —
              2단계 확인이 있고, .nar를 다시 넣어도 되돌아가지 않습니다(사전 파일은 지우지 않고 쓰지 않을 뿐).
            
              사전에서 <B>말투와 1인칭을 증류해 이어받으므로</B>, 갈아탄 뒤에도 어투는 그 아이 그대로입니다. 확인은 버튼 클릭입니다.
            </P>
            <H3>고스트 간 커뮤니케이트</H3>
            <P>
              같은 데스크톱에 있는 <B>다른 고스트와 대화</B>할 수
          ...
          <section className="mb-16">
            ...
            <P>
              SillyTavern 등에서 배포되는 <B>캐릭터 카드(V2 / V3)</B>를,
            ...
            <Steps
              items={[
                ...
                <>PNG 카드는 <B>그 그림이 몸이 되고</B>, 카드의 첫마디로 인사합니다</>,
              ]}
            />
            <Note>
              <B>덮어쓰기가 걱정될 때</B> — 직접 쓴 성격이 들어 있는 경우에는,
          ...
          <section className="mb-16">
            ...
            <P>
              ...
              VOICEVOX의 <B>가창 대응 캐릭터</B>가 필요합니다
            ...
            <P>
              ...
              없으면 <B>동그라미와 선으로 손그림</B>을 그립니다. 그린 그림은
          ...
          <section className="mb-16">
            ...
            <P>
              ...
              퀴즈·즉흥 드라마에 더해, <B>즉흥 송·작사 대결·그림 그리기·일러스트 주제</B>가 있어,
            ...
            <Shot src="/shots/settings-stream.webp" alt="상세 설정의 방송 관련. 방송의 형태, 댓글 수신구, 수다 정도" caption={<>상세 설정의 "방송". 형태·댓글 수신구·수다 정도는 여기에서도 정할 수 있습니다</>} />
            <H3>두 가지 방송의 형태</H3>
            <P>
              <C>/stream host</C>는 <B>이 아이가 방송을 진행하는</B> 형태입니다
              (코너 진행·노래·그림 그리기·마무리의 "엔이-(En-ii)". 시작은 <C>/stream start</C>). <C>/stream assist</C>는 <B>당신이 주인공이고, 이 아이가 단짝 자리에 앉는</B> 형태 —
            ...
            <P>
              ...
              공지문의 초안까지 만듭니다. <B>게시만은 직접 누릅니다</B>
            ...
            <P>
              ...
              (본가와 같은 포트라서, 동시에는 쓸 수 없습니다). <B>방송 사이트별 대응은 댓글 뷰어 쪽에 맡깁니다</B> —
          ...
          <section className="mb-16">
            ...
            <P>
              ...
              Pro는 한 번 구매하는 방식으로, <B>스트리머 모드·시나리오 라이터·인터넷 라디오·Spotify 연동·멀티 고스트</B>가 잠금 해제됩니다(각각의 내용은 <A href="https://pro.mirika.dev/">pro.mirika.dev</A>에).
            </P>
            <Steps
              items={[
                <>
          ...
          <section className="mb-16">
            ...
            <P>
              ...
              <A href="https://discord.gg/fnmUau5qzB">공식 서버</A>
            ...
            <Steps
              items={[
                <>
                  <A href="https://discord.gg/fnmUau5qzB">공식 Discord에 참여</A>하거나,{' '}
                  <A href="https://discord.com/oauth2/authorize?client_id=1533170549940027493&scope=bot+applications.commands&permissions=281836025662465">내 서버에 봇을 초대</A>하거나,{' '}
                  <A href="https://discord.com/oauth2/authorize?client_id=1533170549940027493&integration_type=1&scope=applications.commands">내 계정에 추가</A>(DM에서도 어느 서버에서도 사용 가능)
                </>,
                <>
            ...
            <P>
              ...
              답장 아래 버튼으로 <B>기억</B>을 켜면 대화를 기억합니다
              (본인 것만·언제든 전부 삭제 가능). <C>/todo</C>는{' '}
              <B>데스크톱 TODO와 양방향 동기화</B>되며, 마감이 다가오면
          ...
          <section className="mb-16">
            ...
            <P>
              ...
              그래도 상태가 이상할 때는 <C>/log</C> —— <B>동작 로그가 든 폴더가 열립니다</B>
          ...
          <section className="mb-8">
            ...
            <H3>노래하지 않는다</H3>
            <P>
              노래에는 VOICEVOX의 <B>가창 대응 캐릭터</B>가 필요합니다.

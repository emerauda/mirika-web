...
function Shell({ title, children }: { title: string; children: ReactNode }) {
  return (
    <div className="relative z-10 mx-auto max-w-3xl px-5 sm:px-8 pt-28 pb-24">
      ...
      <p className="mt-3 font-mono text-xs text-mist">最終更新: {UPDATED}</p>
...
export function Privacy() {
  return (
    <Shell title="プライバシーポリシー">
      ...
      <P>
        Pro
        や組織向けのライセンスを使う場合、キーの確認と方針の受け取りのために私たちのサーバーと通信します。このとき扱うのは、ライセンスの識別子、端末名、アプリのバージョン、最後に確認した日時です。
      ...
      <P>
        ...
        <strong className="text-cream">誰が何台使っているか、最後にいつ使ったか</strong>

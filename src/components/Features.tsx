...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    num: '10',
    title: '渡した書類を、そのまま読む',
    desc: 'テキスト・Markdown・PDF・Word・Excel・PowerPoint・画像を窓に落とすだけ。**変換も貼り付けもいりません**。契約書の条文も、見積の品目も、スライドの流れも、そのまま話の前提になる。画面をそのまま見せることもできて(既定オフ)、エラーの画面を撮って「これ何?」と聞ける。文字コードは中身から見分けるので、**Shift_JIS のままの古いテキストも化けません**。読んだものは端末から出ません。',
  },
];

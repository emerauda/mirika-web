...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    num: '09',
    title: 'どのマシンにも、同じ子',
    desc: 'PC を替えても同じ子・同じ記憶。記憶と人格を暗号化した1ファイルで持ち出せて、置き場に Dropbox・OneDrive・Google Drive・iCloud などの同期フォルダを指定すれば、そのクラウド経由で15分ごとに自動で合わせる(こちらのサーバーは経由せず、クラウドに置かれるのは暗号文だけ)。鍵は合言葉から作ってその端末から出さないので、置き場が漏れても中身は読めない。取り込みは上書きではなく突き合わせ——どちらの端末にしかない会話も残り、片方で消したタスクが復活することもない。ここまでは無料。',
  },
  {
    Icon: Users,
    num: '10',

...
const ITEMS: Item[] = [
  ...
  },
  {
    ...
    a: 'もう使えます。正式版 0.5.6 を mirika.dev と公開ミラーから配布中で、先行版(BETA枠)では 0.6.0-rc.0 を試せます(Windows / Linux はすぐ入手可、macOS は署名・公証の対応まで準備中)。Phase 4(AI秘書)までは実データで完了——Gmail・カレンダー・Drive 連携、タスク預かり、定期チェックとブリーフィング、画面理解と見守り、ローカルRAG、ブラウザ拡張まで動いています。Phase 5(プロダクト化)、Phase 6(エコシステム)も完了し、いまは Phase 7(社会と身体)を進めています。開発への参加も歓迎で、公開リポジトリへのフィードバックや Issue / PR、Booth の開発支援版での後押しができます。',
  },
];
